...
The validated core Retry Policy defaults to three attempts, caps the initial
delay at one hour, and uses increasing delays between typed transient transfer
attempts. Journal and recovery boundaries remain authoritative for resume.
